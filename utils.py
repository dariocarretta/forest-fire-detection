...
heatmap = np.load('/home/dario/Desktop/FlameSentinels/sample_data/PATCHES_LABELS/greece_patch_(10752, 8960).npy')
...
smoothed_heatmap = grey_erosion(temp, size=kernel_size)  # Then smooth
